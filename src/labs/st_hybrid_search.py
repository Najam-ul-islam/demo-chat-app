# src/labs/L4_rag_hybrid_search.py
...
if not FOUNDRY_PROJECT_ENDPOINT:
    raise RuntimeError("Missing FOUNDRY_PROJECT_ENDPOINT")

if not FOUNDRY_AGENT_NAME:
    raise RuntimeError("Missing FOUNDRY_AGENT_NAME")

if not FOUNDRY_AGENT_VERSION:
    raise RuntimeError("Missing FOUNDRY_AGENT_VERSION")
...
def run_agent():
    ...
    uvicorn.run(
        "src.labs.L4_rag_hybrid_search:app",
        host="127.0.0.1",
        port=8000,
        reload=True,
    )
